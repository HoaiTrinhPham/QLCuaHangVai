...
namespace QLCuaHangVai
{
    public class DungChung
    {
        ...
        public SqlConnection connect()
        {
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["CSDL"] == null ? 
                @"Data Source=ARIESAPRIL\HH;Initial Catalog=QLCuaHangVai;Integrated Security=True" :
                ConfigurationManager.ConnectionStrings["CSDL"].ConnectionString);
